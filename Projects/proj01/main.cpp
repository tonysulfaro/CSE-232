...
int main(){
    ...
    double monthly_payment_minus_fees = car_price - downpayment * ((monthly_rate * pow((1 + monthly_rate), month_duration)/ pow((1+ monthly_rate),month_duration-1)));
    cout << "The monthly payment for the car is " << fixed << setprecision(2) << monthly_payment_minus_fees << endl;
    return 0;
}