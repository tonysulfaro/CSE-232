...
int main() {
    ...
    long beginning, end, print_condition;
    long largest_number = 0, largest_number_location = 0, digit_count = 0, temp_digit_count = 0, digit_count_location = 0;
    ...
    //error handling
    if(beginning > end or end <= 2 or beginning <= 2){
        cout << "Error" << endl;
        return 0;
    }
